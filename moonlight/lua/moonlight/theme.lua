...
theme.set_highlights = function()
  ...
  hl(0, "FloatTitle", { fg = c.border, bg = c.bg_float })
  ...
  hl(0, "LspInfoBorder", { fg = c.border, bg = c.bg_float })
  ...
  hl(0, "BlinkCmpDocBorder", { fg = c.border, bg = c.bg_float })
  ...
  hl(0, "BlinkCmpMenuBorder", { fg = c.border, bg = c.bg_float })
  hl(0, "BlinkCmpSignatureHelp", { fg = c.fg, bg = c.bg_float })
  hl(0, "BlinkCmpSignatureHelpBorder", { fg = c.border, bg = c.bg_float })

  -- Rainbow
  hl(0, "RainbowCyan", { fg = c.cyan, bg = 'NONE' })
  hl(0, "RainbowBlue", { fg = c.blue3, bg = 'NONE' })
